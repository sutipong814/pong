...
cl = LINETCR.LINE()
cl.login(token="Es7Y2irkQBULZctlQEg3.IsKBmTigy3TVpzNAYdpo0W.0332kXRubecdftXEex62tnj6480xifRcvRIR/8WvMuY=")
cl.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = ["u307452846a69d19df19750a1ebc72300",mid]
self = ["u307452846a69d19df19750a1ebc72300",mid]
admin = "u307452846a69d19df19750a1ebc72300"
admsa = "u307452846a69d19df19750a1ebc72300"
owner = "u307452846a69d19df19750a1ebc72300"
adminMID = "u307452846a69d19df19750a1ebc72300"
Creator="u307452846a69d19df19750a1ebc72300"
wait = {
    "alwayRead":False,
    "detectMention":True,    
    "kickMention":False,
...
#===========================================
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "ubf1cc4b597506c009461d8392cd03373":
                    if "join:" in msg.text:
...
#----------------------------------------------------------------------------
                ...
                msg.contentType = 13
                adm = 'ubf1cc4b597506c009461d8392cd03373'
                msg.contentMetadata = {'mid': adm}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"Add Line ")
                cl.sendText(msg.to,"👆 สนใจ แอดทักมาคุย กันได้นะครับ 👆")
#=========================================
...
#==================================================
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    ki.updateProfile(profile)
                        ...
                        ki1.sendText(msg.to,"[By:☬sutipong☬]")
                        ki2.sendText(msg.to,"[Do not think  will try.]")
                        ki3.sendText(msg.to,"[ By:☬sutipong☬]")
